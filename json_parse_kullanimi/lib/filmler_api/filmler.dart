import 'package:json_parse_kullanimi/filmler_api/kategoriler.dart';
import 'package:json_parse_kullanimi/filmler_api/yonetmeler.dart';
...
class Filmler {
  ...
  factory Filmler.fromJson(Map<String, dynamic> json) {
    return Filmler(
      ...
      kategori: Kategoriler.fromJson(json["kategori"] as Map<String, dynamic>),
      yonetmen: Yonetmenler.fromJson(json["yonetmen"] as Map<String, dynamic>),
    );
  }
}
